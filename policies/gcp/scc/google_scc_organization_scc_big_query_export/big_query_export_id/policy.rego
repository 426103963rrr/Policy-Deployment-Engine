  ...
  [
    {
      ...
      "remedies": ["Use one of the approved export IDs (e.g., scc_export_prod_australia-southeast1)."]
    },
    {
      "condition": "Export ID must match approved list.",
      "attribute_path": ["big_query_export_id"],
      "values": approved_export_ids,
